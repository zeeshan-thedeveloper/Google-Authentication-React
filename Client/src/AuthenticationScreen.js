        ...
        <div>
            <Grid container>
                ...
                <Grid item lg={10} md={10} sm={12} >
                    <Card
                        elevation={0}
                        style={{border:lightBorder,marginLeft:'auto',marginRight:'auto',marginTop:'2rem',width:'30rem',height:'40rem'}}
                    >
                        <CardContent>
                            
                            {
                                (!doHaveAccount) && <div>
                                    <SinUpForm doHaveAccount={doHaveAccount} setDoHaveAccount={setDoHaveAccount}/>
                                </div>
                            }
                            {
                                (doHaveAccount) && <div>
                                    <SinInForm  doHaveAccount={doHaveAccount} setDoHaveAccount={setDoHaveAccount}/>
                                </div>
                            }
                        </CardContent>
                    </Card>
